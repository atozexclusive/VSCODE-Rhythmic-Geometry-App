...
export const SITE_MODE_CARDS: SiteModeCard[] = [
  {
    ...
    description:
      'Orbit is the original surface. Pulse, spacing, and direction turn into moving form and clear visual rhythm.',
    details: [
  ...
  },
  {
    ...
    description:
      'Study makes rhythm relationships visible. Start with one ring or a clean 3:5, then hear how the layers line up.',
    details: [
  ...
  },
  {
    ...
    description:
      'Riff keeps the bar, phrase, and ending distinct so the groove stays clear while you write and reshape it.',
    details: [
      'Best for groove writing and return',
      'Bar, pattern, and ending stay separate enough to edit clearly',
      'Focused pattern editing for close work',
    ],
    bestFor: 'Groove structure, phrase shape, and return',
    firstMove: 'Load a scene, press Play, then change one step in the riff.',
    accent: '#FFD166',
    image: '/scene-captures/website_riff_mode.png',
    imagePosition: '50% 42%',
    launchLabel: 'Open Riff',
  },
];
