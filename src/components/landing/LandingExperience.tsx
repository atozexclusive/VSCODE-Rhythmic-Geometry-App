...
const features = [
  { title: 'Scene Library', text: 'Explore polyrhythm breakdowns, ready-to-play scenes, and riff studies inspired by artists like Meshuggah. Slow them down, hear how the layers fit together, and make them your own.', image: '/landing-media/tool-library.png', caption: 'Browse real scenes and load a starting point.', href: '/scenes', action: 'Explore the library' },
